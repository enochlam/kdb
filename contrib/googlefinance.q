...
goog0:{[site;offset;stocks] / goog[100;`GOOG`AMZN], start q with slaves to take advantage of peach
	...
	tbl,:raze{$["200"~3#9_r:httpget["www.google.com"]"/finance/historical?q=",(string x),y;update Sym:x from select from("DEEEEI ";enlist",")0:{(x ss"Date,Open")_ x}r;z]}[;parms;tbl]peach distinct upper stocks,();
